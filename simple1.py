...
#
#
# 5 letter captcha generator using uppercase & lowercase letters. added timer and save button for further uses
#
#
...
class CaptchaApp:
    ...
    def generate_random_text(self):
        # Generate a random string of 5 characters, so that no consecutive characters are the same
    ...
    def generate_captcha_image(self, text):
        ...
        for i, char in enumerate(text):
            ...
            font_size = random.randint(24, 28) if char.islower() else random.randint(30, 36)  # Smaller font for lowercase
